...
```bash
npx skills add https://github.com/EchoLab-Auto/skill-language-standards --skill skill-language-standards --agent claude-code -y
```

## Skill 说明

`skill-language-standards` skill 会指导 Claude Code Agent：
